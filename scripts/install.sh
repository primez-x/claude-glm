...
Options:
  --force          Overwrite existing launcher/prompt/hook files.
...
install_file "$REPO_ROOT/bin/claude-glm" "$BIN_DIR/claude-glm" 0755
install_file "$REPO_ROOT/prompts/fable-provider-native-system.md" "$CLAUDE_DIR/prompts/fable-provider-native-system.md" 0644
